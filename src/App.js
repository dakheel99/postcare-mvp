    ...
    <div style={{ minHeight:"100vh", background:"#030712", color:"#f9fafb", fontFamily:"'Segoe UI',Tahoma,Arial,sans-serif", direction:"rtl", padding:"0 0 40px" }}>
      ...
      <div style={{ background:"#111827", borderBottom:"1px solid #1f2937", padding:"16px 24px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div>
            <div style={{ fontWeight:700, fontSize:15 }}>منصة أمان ما بعد العمليات الجراحية</div>
            <div style={{ fontSize:11, color:"#6b7280" }}>منصة أمان ما بعد العمليات</div>
          </div>
        </div>
    ...
    <div style={{ minHeight:"100vh", background:"#030712", color:"#f9fafb", fontFamily:"'Segoe UI',Tahoma,Arial,sans-serif", direction:"rtl" }}>
      ...
      <div style={{ background:"#111827", borderBottom:"1px solid #1f2937", padding:"14px 24px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div><div style={{ fontWeight:700,fontSize:16 }}>أمان ما بعد العمليات</div><div style={{ fontSize:11,color:"#6b7280" }}>منصة منصة أمان ما بعد العمليات الجراحية</div></div>
        </div>
        <div style={{ display:"flex",alignItems:"center",gap:12 }}>
          ...
          <div style={{ display:"flex",alignItems:"center",gap:6,background:"#1f2937",borderRadius:10,padding:"6px 12px" }}><div style={{ width:8,height:8,borderRadius:"50%",background:"#10b981" }}></div><span style={{ fontSize:11,color:"#6b7280" }}>منصة أمان ما بعد العمليات</span></div>
        </div>
      </div>
      ...
      <div style={{ padding:24, maxWidth:1200, margin:"0 auto" }}>
        ...
        {tab==="reports" && (
          <div style={card}>
            <div style={{ ...cardH,padding:20 }}><span style={{ fontWeight:700,fontSize:16 }}>📋 تقرير منصة أمان ما بعد العمليات</span></div>
            <div style={{ padding:20 }}>
